...
var file_demo_proto_rawDesc = []byte{
	...
	0x65, 0x32, 0x43, 0x0a, 0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x12, 0x33, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x12, 0x2e,
...
var file_demo_proto_depIdxs = []int32{
	0, // 0: demo.HelloService.GetHello:input_type -> demo.HelloRequest
	1, // 1: demo.HelloService.GetHello:output_type -> demo.HelloResponse
...
func (c *helloServiceClient) GetHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/demo.HelloService/GetHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloService_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demo.HelloService/GetHello",
	}
